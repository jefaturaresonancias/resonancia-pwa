...
const ConfigView = (() => {
  ...
  // La grilla en sí vive en js/views/panoramaSemanal.js (compartida con el
  // botón de Agenda, 28/8/2026, a pedido) — acá solo se arma el envoltorio
  // de la sección (título + botón exportar) y se le pasan los datos ya
  // cargados en cargar().
